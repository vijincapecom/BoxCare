            ...
            <div className="container mx-auto max-w-[85rem] px-10 ">
                <div className="py-12">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div>
                            <Image src={img6} width={500} height={800} alt="logo" className="w-full h-full transition-all duration-200 hover:scale-105" />
                        </div>
                        ...
                        <div >
                            ...
                            <div className="mt-10 relative">
                                <ol className="relative space-y-8 before:content-[''] before:absolute before:top-0 before:bottom-0 before:left-5 md:before:left-6 before:border-l-2 before:border-dashed before:border-[#8E98A8]">
