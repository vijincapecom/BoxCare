                ...
                <div className="py-18">
                    <div className='grid lg:grid-cols-2 gap-8'>
                        <div>
                            ...
                            <h1 className='dm-sans font-medium text-[#0F172A] text-[20px] sm:text-[38px] xl:text-[44px] mt-1 leading-14 mt-2'>Your Brand Deserves the
                                <br />
                                Best - <span className='text-[#B4DD13]'>Here’s Why We Deliver</span>
                            </h1>

                            <div className='mt-12 rounded-lg border bg-white'>
                                <ul className='divide-y'>
                                    {
                                        features.map((feature, index) => (
                                            <li key={index} className="grid grid-cols-[72px_1fr] items-center gap-4 ">
                                                <div className="flex items-center justify-center">
                                                    <Image src={l7} width={30} height={30} alt="logo" className="w-[30px] h-[30px] " />
                                                </div>
                                                <div className="border-l pl-4 md:pl-4">
                                                    <div className='p-6 md:p-3.5'>
                                                        <h3 className="text-[18px] font-normal dm-sans text-[#0F172A]">{feature.title}</h3>
                                                        <p className="mt-2 text-[14px] font-normal dm-sans text-[#0F172A] leading-7">{feature.description}</p>
                                                    </div>
                                                </div>
                                            </li>
                                        ))
                        ...
                        <div>
                            ...
                            <div className='mt-10'>
                                <Image src={img6} width={300} height={400} alt="logo" className="w-full h-full " />
                            </div>
                        </div>
                    </div>
                </div>
